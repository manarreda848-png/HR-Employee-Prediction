...
.stApp { background: radial-gradient(circle at 10% 10%, rgba(255,182,213,.22), transparent 28%), radial-gradient(circle at 90% 15%, rgba(244,143,177,.18), transparent 30%), linear-gradient(135deg,#fff8fb 0%,#fff1f6 48%,#fff9fc 100%); }
.main .block-container { padding-top:2rem; padding-bottom:3rem; max-width:1400px; }
h1,h2,h3 { font-family:'Poppins',sans-serif !important; color:#9d315d !important; font-weight:700 !important; }
p,label,.stMarkdown,.stCaption { color:#5f4652; }
[data-testid="stSidebar"] { background:linear-gradient(180deg,#fff0f6 0%,#ffe4ef 100%); border-right:1px solid #f5bfd3; }
[data-testid="stSidebar"] h1,[data-testid="stSidebar"] h2,[data-testid="stSidebar"] h3 { color:#9d315d !important; }
[data-testid="stSidebar"] [role="radiogroup"] label { border-radius:12px; padding:8px 12px; margin:3px 0; }
div.stButton > button, div[data-testid="stFormSubmitButton"] > button { background:linear-gradient(135deg,#e85d8d,#c93d70); color:white; border:none; border-radius:12px; padding:.65rem 1.25rem; font-family:'Poppins',sans-serif; font-weight:600; box-shadow:0 6px 18px rgba(201,61,112,.20); transition:all .2s ease; }
div.stButton > button:hover, div[data-testid="stFormSubmitButton"] > button:hover { background:linear-gradient(135deg,#d94c7e,#b83262); transform:translateY(-1px); }
div[data-testid="stMetric"] { background:rgba(255,255,255,.90); border:1px solid #f4c3d6; border-radius:16px; padding:16px; box-shadow:0 6px 20px rgba(157,49,93,.07); }
div[data-testid="stMetricLabel"] { color:#9d315d !important; font-weight:600; }
div[data-testid="stMetricValue"] { color:#6f2142 !important; }
div[data-baseweb="input"] > div, div[data-baseweb="select"] > div { border-color:#efb5cb !important; border-radius:10px !important; background-color:#fffafd !important; }
div[data-baseweb="input"] > div:focus-within, div[data-baseweb="select"] > div:focus-within { border-color:#df5d8b !important; box-shadow:0 0 0 1px #df5d8b !important; }
[data-testid="stDataFrame"] { border:1px solid #f2c3d5; border-radius:14px; overflow:hidden; }
hr { border-color:#f2c3d5; }
.stCaption { color:#8a6473 !important; }
div[data-testid="stRadio"] label, div[data-testid="stSelectbox"] label, div[data-testid="stNumberInput"] label { color:#6f2142 !important; font-weight:600; }
</style>
